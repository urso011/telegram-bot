...
CREATE TABLE IF NOT EXISTS bot_config(
    ...
    main_img TEXT DEFAULT 'https://imgdb.net/storage/uploads/396196e55f64d2b624b0a38d4cf36488f04a6a86c3b73ebd2a9bae424cad30c7.jpg',  -- Link da imagem do /start
    support_user TEXT DEFAULT '/start',                               -- Username de atendimento
    channel_user TEXT DEFAULT '@WhitexCards',                                    -- Canal de notícias
    is_on INTEGER DEFAULT 1,                                                    -- Se o bot está on ou em manutenção
    gate_chk TEXT DEFAULT 'companychk02',                                            -- Gate para chk
    gate_chk_publico TEXT DEFAULT 'companychk02',                                            -- Gate para chk publico
    gate_exchange TEXT DEFAULT 'companychk02',                                       -- Gate para troca
